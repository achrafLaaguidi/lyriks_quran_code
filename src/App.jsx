  ...
  return (
    <div className="relative flex ">
      ...
      {(activeSong?.id || activeTafsir?.id) && (
        <div className="absolute h-28 md:bottom-0 sm:bottom-12 bottom-4  left-0 right-0 flex animate-slideup bg-gradient-to-br from-white/10 to-[#2a2a80] backdrop-blur-lg rounded-3xl z-50">
          <MusicPlayer />
        </div>
      )}
